var AppTemplate = function () {
  ...
  var handleTheme = function () {
    ...
    var setColor = function (color) {
      ...
      $('#logoimg').attr("src", "images/template/logo_" + color + ".png");
      $('#rev-hint1').attr("src", "images/template/sliders/revolution/hint1-" + color + ".png");
      $('#rev-hint2').attr("src", "images/template/sliders/revolution/hint2-" + color + ".png");
    }
  ...
  var handleAccordions = function () {
    ...
    $('body').on('click', '.accordion.scrollable .accordion-toggle', function () {
      lastClicked = $(this);
    }); //move to faq section
